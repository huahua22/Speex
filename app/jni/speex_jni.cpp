//
// Created by xwr on 2019/12/16.
//

#include "com_xwr_speex_SpeexUtil.h"
#include <string.h>
#include <unistd.h>
...
extern "C" jint  Java_com_xwr_speex_SpeexUtil_open(
...
extern "C"  jint  Java_com_xwr_speex_SpeexUtil_encode(
...
extern "C"  jint Java_com_xwr_speex_SpeexUtil_decode(
...
extern "C"  jint  Java_com_xwr_speex_SpeexUtil_getFrameSize(
...
extern "C"  void  Java_com_xwr_speex_SpeexUtil_close(
        JNIEnv *env, jobject obj) {
...
extern "C"  void Java_com_xwr_speex_SpeexUtil_initEcho(
...
extern "C"  void Java_com_xwr_speex_SpeexUtil_echoCancellation(
...
extern "C"  int Java_com_xwr_speex_SpeexUtil_echoCancellationEncode(
...
extern "C"  jint  Java_com_xwr_speex_SpeexUtil_getAecStatus(
        JNIEnv * env, jobject jobj) {
    return (jint) aec_status;
}

extern "C"  void Java_com_xwr_speex_SpeexUtil_destroyEcho(
        JNIEnv * env, jobject jobj) {
